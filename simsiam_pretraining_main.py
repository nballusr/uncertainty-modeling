...
parser.add_argument("--num_mlp_layers", type=int, default=2, help="Number of MLP layers. It can be 2 or 3")
...
model = SimSiamModel(dataloader_train_kNN, gpus, knn_k, knn_t, args.epochs, num_mlp_layers, initial_lr,
                         weight_decay)
